...
# Create a basic eeprom. Offset 44..49 is the manufacturing date as MMDDYY;
# this template carries 010125 (Jan 1 2025), a date no real PB2 was built on.
#
# The date is belt-and-suspenders only. What actually keeps a repaired board
# from colliding with a real one is the unit-number marker below, which holds
# whatever date this template ends up carrying.
#
...
00000020: 3047 4130 4131 3030 3031 3031 3235 5042  0GA0A100010125PB
