...
void BBBPinProvider::Init() {
    if (BBB_PINS.empty()) {
        ...
        if (getBeagleBoneType() == PocketBeagle) {
            ...
            BBB_PINS.emplace_back("P1-08", 2).setPwm(0, 0, 3).setUART("ttyS2-rx");
            BBB_PINS.emplace_back("P1-10", 3).setPwm(0, 1, 3).setUART("ttyS2-tx");
            ...
            BBB_PINS.emplace_back("P1-33", 111).setPRU(0, 1).setPwm(0, 1, 1);
            BBB_PINS.emplace_back("P1-34", 26);
            BBB_PINS.emplace_back("P1-35", 88).setPRU(1, 10);
            BBB_PINS.emplace_back("P1-36", 110).setPRU(0, 0).setPwm(0, 0, 1);
            ...
            BBB_PINS.emplace_back("P8-45", 70).setPRU(1, 0).setPwm(2, 0, 3);
            BBB_PINS.emplace_back("P8-46", 71).setPRU(1, 1).setPwm(2, 1, 3);
            ...
            BBB_PINS.emplace_back("P9-21", 3).setPwm(0, 1, 3).setUART("ttyS2-tx");
            BBB_PINS.emplace_back("P9-22", 2).setPwm(0, 0, 3).setUART("ttyS2-rx");
            ...
            BBB_PINS.emplace_back("P9-29", 111).setPRU(0, 1).setPwm(0, 1, 1);
            BBB_PINS.emplace_back("P9-30", 112).setPRU(0, 2);
            BBB_PINS.emplace_back("P9-31", 110).setPRU(0, 0).setPwm(0, 0, 1);
