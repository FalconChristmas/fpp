...
START:
	...
	MOV	r15, GPIO0 | GPIO_SETDATAOUT
	MOV	r16, GPIO1 | GPIO_SETDATAOUT
	MOV	r17, GPIO2 | GPIO_SETDATAOUT
	MOV	r18, GPIO3 | GPIO_SETDATAOUT

	MOV	r19, GPIO0 | GPIO_CLEARDATAOUT
	MOV	r20, GPIO1 | GPIO_CLEARDATAOUT
	MOV	r21, GPIO2 | GPIO_CLEARDATAOUT
...
//			MOV	gpio3_zeros, 0
			...
			OUTPUT_ROW(11, r11.b0, r11.b1, r11.b2)
			OUTPUT_ROW(12, r11.b3, r12.b0, r12.b1)
			OUTPUT_ROW(21, r12.b2, r12.b3, r13.b0)
			OUTPUT_ROW(22, r13.b1, r13.b2, r13.b3)

			OUTPUT_ROW(31, r14.b0, r14.b1, r14.b2)
			OUTPUT_ROW(32, r14.b3, r15.b0, r15.b1)
			...
			SLEEPNS	650, 1, wait_start_time

			// Send all the start bits
//			SBBO	gpio0_led_mask, r15, 0, 4
//			SBBO	gpio1_led_mask, r16, 0, 4
			SBBO	gpio2_led_mask, r17, 0, 4
			//SBBO	gpio3_led_mask, r18, 0, 4
...
//			SBBO	gpio0_zeros, r19, 0, 4
//			SBBO	gpio1_zeros, r20, 0, 4
			SBBO	gpio2_zeros, r21, 0, 4
			...
			SLEEPNS	850, 1, sleep_one_time  // Wait a little longer to fix the timing

			// Turn all the bits off
//			SBBO	gpio0_led_mask, r19, 0, 4
//			SBBO	gpio1_led_mask, r20, 0, 4
			SBBO	gpio2_led_mask, r21, 0, 4
