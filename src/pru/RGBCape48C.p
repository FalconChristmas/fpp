 ...
 * 
 ****************************************************************************
 * NOTE: This file is a modified copy of the osresearch LEDscape's
 *       LEDscape/src/ledscape/ws281x.p file.  The GPIO and pin #define's
 *       below have been updated to to support the additional outputs on
 *       RGB123's RGBCape48C.  This minimal change has been made to make
 *       syncing code updates from LEDscape easier in the future.
 */
