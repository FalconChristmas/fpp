...
# gstreamer/libdrm are DETECTED in makefiles/common/setup.mk, which plugins
# include too -- the -I and -pthread flags have to be identical everywhere or
