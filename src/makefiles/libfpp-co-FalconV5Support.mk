...
TARGETS += libfpp-FalconV5Support.$(SHLIB_EXT) libFalconV5.$(SHLIB_EXT)
OBJECTS_ALL+=$(OBJECTS_fpp_FalconV5Support_so)

libFalconV5.$(SHLIB_EXT): non-gpl/FalconV5Support/libFalconV5.$(SHLIB_EXT).zst
	zstd -d non-gpl/FalconV5Support/libFalconV5.$(SHLIB_EXT).zst -o libFalconV5.$(SHLIB_EXT)

libfpp-FalconV5Support.$(SHLIB_EXT): $(OBJECTS_fpp_FalconV5Support_so) libfpp.$(SHLIB_EXT) 
