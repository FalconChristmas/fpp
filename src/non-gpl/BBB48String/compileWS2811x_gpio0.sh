...
# clpru versions
/usr/bin/cpp -P -I/opt/fpp/src/pru $@ $CPPFLAG /opt/fpp/src/non-gpl/BBB48String/FalconWS281x.asm > /tmp/FalconWS281x_gpio0.asm
clpru -v3 -o $@ $CPPFLAG /tmp/FalconWS281x_gpio0.asm
