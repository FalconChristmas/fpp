...
var _playlist = require('./stores/playlist');
...
exports.default = {
    ...
    methods: {
        ...
        initStores: function initStores() {
            _playlist2.default.init();
            _setting2.default.init();
        },
        ...
        playPrev: function playPrev(e) {
            if ((0, _jquery2.default)(e.target).is('input,textarea')) {
                return true;
            }
        ...
        search: function search(e) {
            ...
            (0, _jquery2.default)('#searchForm input[type="search"]').focus().select();
            e.preventDefault();
        },
...
var _falconLoading = require("./falcon-loading.vue");

var _falconLoading2 = _interopRequireDefault(_falconLoading);
...
},{"vue":23,"vue-hot-reload-api":3}],33:[function(require,module,exports){
'use strict';
...
exports.default = {
    ...
    init: function init() {
        this.state.settings = _shared2.default.state.settings;
    },
    all: function all() {
    ...
    update: function update() {
        ...
        _http2.default.post('settings', this.all(), function (msg) {
            if (cb) {
                cb();
            }
        });
...
exports.default = {
    ...
    init: function init() {
        ...
        _http2.default.get('data', {}, function (data) {
            _this.state.fppd = data.fppd;
            _this.state.settings = data.settings;
            _this.state.playlists = data.playlists;
            _this.state.schedule = data.schedule;
            _this.state.currentUser = data.user;
