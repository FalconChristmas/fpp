...
?>
    ...
    <div class="clear"></div>
      <div>
        <b>Git Status:</b><br>
        <pre id='gitStatusPre'><?php echo $git_status; ?></pre>
      </div>
      <div>
        <b>Debug Actions:</b><br>
        <ul>
        <li><b>UI Warnings:</b><br>
        Disable restart/reboot UI Warnings: <?php PrintSettingCheckbox("Disable restart/reboot UI Warnings", "disableUIWarnings", 0, 0, "1", "0"); ?><br>
