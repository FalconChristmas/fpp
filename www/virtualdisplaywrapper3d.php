...
<head>
    ...
    <style>
        ...
        .controlButtons, .controls, button, input, label, h1, h2, h3, h4, p, ul, li, div:not(#canvas-container) {
...
<body<?php if ($standalone) echo ' style="margin:0;padding:0;"'; ?>>
    <?php if ($standalone): ?>
        ...
        <div class="mainContainer">
            ...
            <div class="pageContent">
                ...
                <ul style="font-size: 0.9em;">
                    <li><b>⭐ Standalone Mode:</b> <code>?standalone=true</code> - <b>Full window visualizer with NO UI elements</b> (perfect for dedicated displays!)</li>
                    ...
                    <li><b>Combine multiple:</b> <code>?standalone=true&zoom=0.8&brightness=2.5&ambientLight=0.3&holidayMode=true</code>
                    </li>
                </ul>
                <br>
