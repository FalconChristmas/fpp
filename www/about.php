                                ...
                                <table class='tblAbout'>
                                    ...
                                    <tr id='osSelectRow'>
                                        ...
                                        <td><select class='OSSelect' id='OSSelect' onChange='OSSelectChanged();'>
                                            ...
                                            if ($settings['uiLevel'] > 0) {
                                                echo "<br><span><i class='fas fa-fw fa-timeline ui-level-1'></i> Show Legacy OS's <input type='checkbox' id='LegacyOS' onClick='PopulateOSSelect();'><img id='allPlatforms_img' title='Included Historic OS releases in listing' src='images/redesign/help-icon.svg' class='icon-help'></span>";
                                            }
