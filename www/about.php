...
function get_server_memory_usage()
{
    ...
    while ($line = fgets($fh)) {
        ...
        if (preg_match('/^MemTotal:\s+(\d+)\skB$/', $line, $pieces)) {
            $total = $pieces[1];
        } elseif (preg_match('/^MemFree:\s+(\d+)\skB$/', $line, $pieces)) {
            $free = $pieces[1];
        } elseif (preg_match('/^Buffers:\s+(\d+)\skB$/', $line, $pieces)) {
            $buffers = $pieces[1];
        } elseif (preg_match('/^Cached:\s+(\d+)\skB$/', $line, $pieces)) {
            $cached = $pieces[1];
        }
    }
    fclose($fh);
      ...
      <div>
        <div class='aboutLeft'>
          <table class='tblAbout'>
            ...
            <tr><td>FPP Version:</td><td><?php echo $fpp_version; ?></td></tr>
            <tr><td>FPP OS Build:</td><td><?php echo $os_build; ?></td></tr>
            <tr><td>OS Version:</td><td><?php echo $os_version; ?></td></tr>
            <tr><td>Kernel Version:</td><td><?php echo $kernel_version; ?></td></tr>
<?php if (file_exists($mediaDirectory."/.developer_mode")) {
    ?>
            <tr><td>Git Branch:</td><td><select id='gitBranch' onChange="ChangeGitBranch($('#gitBranch').val());">
<?php PrintGitBranchOptions(); ?>
                </select></td></tr>
<?php

} else {
    ?>
            <tr><td>Git Branch:</td><td><?php echo $git_branch; ?></td></tr>
<?php
...
<?php if (file_exists($mediaDirectory."/.auto_update_disabled")) {
    ?>
            checked
<?php 
} ?>
...
-->
            ...
            <tr><td>CPU Usage:</td><td><?php printf("%.2f", get_server_cpu_usage()); ?>%</td></tr>
            <tr><td>Memory Usage:</td><td><?php printf("%.2f", get_server_memory_usage()); ?>%</td></tr>

            <tr><td>&nbsp;</td><td>&nbsp;</td></tr>
            <tr><td><b>Uptime</b></td><td>&nbsp;</td></tr>
            <tr><td colspan='2'><?php echo $uptime; ?></td></tr>
        ...
        <div class='aboutRight'>
          <table class='tblAbout'>
            ...
            <tr><td>Playlists:</td><td><a href='playlists.php' class='nonULLink'><?php echo getFileCount($playlistDirectory); ?></a></td></tr>
            <tr><td>Sequences:</td><td><a href='uploadfile.php?tab=0' class='nonULLink'><?php echo getFileCount($sequenceDirectory); ?></a></td></tr>
            <tr><td>Audio Files:</td><td><a href='uploadfile.php?tab=1' class='nonULLink'><?php echo getFileCount($musicDirectory); ?></a></td></tr>
            <tr><td>Videos:</td><td><a href='uploadfile.php?tab=2' class='nonULLink'><?php echo getFileCount($videoDirectory); ?></a></td></tr>
            <tr><td>Events:</td><td><a href='events.php' class='nonULLink'><?php echo getFileCount($eventDirectory); ?></a></td></tr>
            <tr><td>Effects:</td><td><a href='uploadfile.php?tab=3' class='nonULLink'><?php echo getFileCount($effectDirectory); ?></a></td></tr>
            <tr><td>Scripts:</td><td><a href='uploadfile.php?tab=4' class='nonULLink'><?php echo getFileCount($scriptDirectory); ?></a></td></tr>
			<tr><td>Remapped Channels:</td><td><a href='channelremaps.php' class='nonULLink'><?php echo getRemappedChannelCount(); ?></a></td></tr>
