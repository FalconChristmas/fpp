...
function uninstallPlugin(pluginName) {
    ...
    $.get("fppxml.php?command=uninstallPlugin&plugin=" + pluginName).success(function() {
...
function installPlugin(pluginName) {
    ...
    $.get("fppxml.php?command=installPlugin&plugin=" + pluginName).success(function() {
        document.body.style.cursor = "pointer";
        location.reload(true);
    }).fail(function() {
        document.body.style.cursor = "pointer";
...
function ManualGitUpdate() {
    ...
    $.get("fppxml.php?command=manualGitUpdate").success(function() {
        document.body.style.cursor = "pointer";
        location.reload(true);
    }).fail(function() {
...
function ViewReleaseNotes(version) {
    ...
    $.get("fppxml.php?command=viewReleaseNotes&version=" + version).success(function(data) {
        $("#helpText").html(
...
function UpgradeFPPVersion(newVersion) {
    if (confirm('Do you wish to upgrade the Falcon Player?\n\nClick "OK" to continue.\n\nThe system will automatically reboot to complete the upgrade.')) {
        document.body.style.cursor = "wait";
        $.get("fppxml.php?command=upgradeFPPVersion&version=v" + newVersion).success(function() {
            document.body.style.cursor = "pointer";
            location.reload(true);
        }).fail(function() {
            document.body.style.cursor = "pointer";
...
function ChangeGitBranch(newBranch) {
    document.body.style.cursor = "wait";
    $.get("fppxml.php?command=changeGitBranch&branch=" + newBranch).success(function() {
        document.body.style.cursor = "pointer";
        location.reload(true);
    }).fail(function() {
        document.body.style.cursor = "pointer";
...
function RestartFPPD() {
    ...
    $.get("fppxml.php?command=restartFPPD").success(function() {
...
function SetFPPDmode() {
    $.get("fppxml.php?command=setFPPDmode&mode=" + $("#selFPPDmode").val()).success(function() {
