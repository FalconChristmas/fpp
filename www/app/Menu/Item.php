...
class Item {
	...
	/**
	 * Creates a new FPP\Menu\MenuItem instance.
	 *
	 * @param  string  $title
	 * @param  string  $url
     * @param  array  $attributes
     * @param  int  $parent
	 * @param  \FPP\Menu\Menu  $builder
	 * @return void
	 */
	 ...
	 *
	 */
	public function activate( \FPP\Menu\Item $item = null ){
