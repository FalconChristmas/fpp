                        ...
                        <div class="backdrop">
                            <ul class="no-bullets">
                                ...
                                <li><a class="<?= $externalLinkClass ?>"
                                        ...
                                        rel="noopener noreferrer"><i class="fas fa-comments"></i> Got a question? Join
                                ...
                                <li><a class="<?= $externalLinkClass ?>" href="https://falconchristmas.com/forum"
                                        target="_blank" rel="noopener noreferrer"><i class="fas fa-comments"></i> or the
                                        FPP Forums <i class="fas fa-external-link-alt external-link"></i></a></li>
                                <li><a class="<?= $externalLinkClass ?>" href="https://xlights.org/zoom/" target="_blank"
                                        rel="noopener noreferrer"><i class="fas fa-headphones"></i> Prefer to talk? Join
                                        the xLights Zoom room <i class="fas fa-external-link-alt external-link"></i></a>
                                </li>
                                <li><a class="<?= $externalLinkClass ?>"
                        ...
                        <div class="backdrop">
                            <ul>
                                <li><a href='javascript:void(0);'
                                        onClick="helpPage='help/backup.php'; DisplayHelp();">Backup & Restore</a></li>
                                <li><a href='javascript:void(0);'
