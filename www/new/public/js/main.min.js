...
/***/ "./app/Views/components/deviceinformation/deviceinformation.js":
/*!*********************************************************************!*\
  !*** ./app/Views/components/deviceinformation/deviceinformation.js ***!
  \*********************************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var tingle_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tingle.js */ \"./node_modules/tingle.js/dist/tingle.min.js\");\n/* harmony import */ var tingle_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(tingle_js__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _assets_js_helpers_message_bus_message_bus__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../assets/js/helpers/message-bus/message-bus */ \"./app/assets/js/helpers/message-bus/message-bus.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\n\nvar NAME = 'notification-modal';\nvar MESSAGE_HANDLERS = ['revealNotification.all', 'closeNotification.all'];\n\nvar NotificationModal = /*#__PURE__*/function () {\n  function NotificationModal() {\n    _classCallCheck(this, NotificationModal);\n\n    this.messageBus = new _assets_js_helpers_message_bus_message_bus__WEBPACK_IMPORTED_MODULE_1__[\"MessageBus\"]();\n    this.messageBus.connect(this);\n    this.modal = new tingle_js__WEBPACK_IMPORTED_MODULE_0___default.a.modal({\n      closeMethods: ['overlay', 'button', 'escape'],\n      closeLabel: \"sluiten\"\n    });\n  }\n\n  _createClass(NotificationModal, [{\n    key: \"onRevealNotification\",\n    value: function onRevealNotification(evt) {\n      this.modal.setContent(evt.data.data.message);\n      this.modal.open();\n    }\n  }, {\n    key: \"componentName\",\n    get: function get() {\n      return NAME;\n    }\n  }, {\n    key: \"messageHandlers\",\n    get: function get() {\n      return MESSAGE_HANDLERS;\n    }\n  }]);\n\n  return NotificationModal;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (NotificationModal);\n\n//# sourceURL=webpack:///./app/Views/components/notification-modal/notification-modal.js?");

/***/ }),

/***/ "./app/Views/components/sidenav/sidenav.js":
/*!*************************************************!*\
  !*** ./app/Views/components/sidenav/sidenav.js ***!
  \*************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var assets_js_helpers_stimulus_component_controller__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! assets/js/helpers/stimulus/component-controller */ \"./app/assets/js/helpers/stimulus/component-controller.js\");\nfunction _typeof(obj) { \"@babel/helpers - typeof\"; if (typeof Symbol === \"function\" && typeof Symbol.iterator === \"symbol\") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === \"function\" && obj.constructor === Symbol && obj !== Symbol.prototype ? \"symbol\" : typeof obj; }; } return _typeof(obj); }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nfunction _inherits(subClass, superClass) { if (typeof superClass !== \"function\" && superClass !== null) { throw new TypeError(\"Super expression must either be null or a function\"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } }); if (superClass) _setPrototypeOf(subClass, superClass); }\n\nfunction _setPrototypeOf(o, p) { _setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) { o.__proto__ = p; return o; }; return _setPrototypeOf(o, p); }\n\nfunction _createSuper(Derived) { var hasNativeReflectConstruct = _isNativeReflectConstruct(); return function _createSuperInternal() { var Super = _getPrototypeOf(Derived), result; if (hasNativeReflectConstruct) { var NewTarget = _getPrototypeOf(this).constructor; result = Reflect.construct(Super, arguments, NewTarget); } else { result = Super.apply(this, arguments); } return _possibleConstructorReturn(this, result); }; }\n\nfunction _possibleConstructorReturn(self, call) { if (call && (_typeof(call) === \"object\" || typeof call === \"function\")) { return call; } return _assertThisInitialized(self); }\n\nfunction _assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError(\"this hasn't been initialised - super() hasn't been called\"); } return self; }\n\nfunction _isNativeReflectConstruct() { if (typeof Reflect === \"undefined\" || !Reflect.construct) return false; if (Reflect.construct.sham) return false; if (typeof Proxy === \"function\") return true; try { Date.prototype.toString.call(Reflect.construct(Date, [], function () {})); return true; } catch (e) { return false; } }\n\nfunction _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); }\n\n\nvar NAME = 'sidenav';\n\nvar Sidenav = /*#__PURE__*/function (_ComponentController) {\n  _inherits(Sidenav, _ComponentController);\n\n  var _super = _createSuper(Sidenav);\n\n  function Sidenav() {\n    _classCallCheck(this, Sidenav);\n\n    return _super.apply(this, arguments);\n  }\n\n  _createClass(Sidenav, [{\n    key: \"connect\",\n    value: function connect() {\n      console.log('Hello World!');\n    }\n  }]);\n\n  return Sidenav;\n}(assets_js_helpers_stimulus_component_controller__WEBPACK_IMPORTED_MODULE_0__[\"ComponentController\"]);\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  'name': NAME,\n  'controller': Sidenav\n});\n\n//# sourceURL=webpack:///./app/Views/components/sidenav/sidenav.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var Views_components_notification_modal_notification_modal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Views/components/notification-modal/notification-modal */ \"./app/Views/components/notification-modal/notification-modal.js\");\n\n\nconst App = (() => {\n    class App {\n        constructor () {\n            window.app = this;\n            window.messageLogger = false;\n            new Views_components_notification_modal_notification_modal__WEBPACK_IMPORTED_MODULE_0__[\"default\"]();\n        }\n    }\n\n    return App;\n})();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (App);\n\n\n//# sourceURL=webpack:///./app/assets/js/app.js?");

/***/ }),

/***/ "./app/assets/js/helpers/bem.js":
/*!**************************************!*\
  !*** ./app/assets/js/helpers/bem.js ***!
  \**************************************/
/*! exports provided: renderClasses */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"renderClasses\", function() { return renderClasses; });\nfunction renderClasses(block, element = '', modifiers = []) {\n    let cssClass = block;\n\n    if (element) {\n        cssClass = `${cssClass}__${element}`;\n    }\n\n    if (modifiers.length === 0) {\n        return cssClass;\n    }\n\n    return modifiers.map((modifier) => {\n        return `${cssClass}--${modifier}`;\n    }).join(' ');\n}\n\n\n\n\n//# sourceURL=webpack:///./app/assets/js/helpers/bem.js?");

/***/ }),

/***/ "./app/assets/js/helpers/env/origin.js":
/*!*********************************************!*\
  !*** ./app/assets/js/helpers/env/origin.js ***!
  \*********************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var stimulus__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! stimulus */ \"./node_modules/stimulus/index.js\");\n/* harmony import */ var _assets_js_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/js/app */ \"./app/assets/js/app.js\");\n/* harmony import */ var _helpers_stimulus_component_controller__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./helpers/stimulus/component-controller */ \"./app/assets/js/helpers/stimulus/component-controller.js\");\n/* harmony import */ var Views_components_deviceinformation_deviceinformation__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! Views/components/deviceinformation/deviceinformation */ \"./app/Views/components/deviceinformation/deviceinformation.js\");\n/* harmony import */ var Views_components_sidenav_sidenav__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! Views/components/sidenav/sidenav */ \"./app/Views/components/sidenav/sidenav.js\");\n// src/main.js\n\n\n\n\n\n/* component generator replace here */\n\nnew _helpers_stimulus_component_controller__WEBPACK_IMPORTED_MODULE_2__[\"ComponentController\"]();\nconst controllers = [\n    Views_components_deviceinformation_deviceinformation__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n    Views_components_sidenav_sidenav__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\n    /* js component here */\n];\n\nconst application = stimulus__WEBPACK_IMPORTED_MODULE_0__[\"Application\"].start();\n\ncontrollers.forEach((controllerModule) => {\n    application.register(controllerModule.name, controllerModule.controller);\n});\n\n// this is the main application entry point\nnew _assets_js_app__WEBPACK_IMPORTED_MODULE_1__[\"default\"]();\n\n\n//# sourceURL=webpack:///./app/assets/js/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var core_js_fn_array_find__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/fn/array/find */ \"./node_modules/core-js/fn/array/find.js\");\n/* harmony import */ var core_js_fn_array_find__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_array_find__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var core_js_fn_array_find_index__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! core-js/fn/array/find-index */ \"./node_modules/core-js/fn/array/find-index.js\");\n/* harmony import */ var core_js_fn_array_find_index__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_array_find_index__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var core_js_fn_array_from__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! core-js/fn/array/from */ \"./node_modules/core-js/fn/array/from.js\");\n/* harmony import */ var core_js_fn_array_from__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_array_from__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var core_js_fn_map__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! core-js/fn/map */ \"./node_modules/core-js/fn/map.js\");\n/* harmony import */ var core_js_fn_map__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_map__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var core_js_fn_object_assign__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! core-js/fn/object/assign */ \"./node_modules/core-js/fn/object/assign.js\");\n/* harmony import */ var core_js_fn_object_assign__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_object_assign__WEBPACK_IMPORTED_MODULE_4__);\n/* harmony import */ var core_js_fn_promise__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! core-js/fn/promise */ \"./node_modules/core-js/fn/promise.js\");\n/* harmony import */ var core_js_fn_promise__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_promise__WEBPACK_IMPORTED_MODULE_5__);\n/* harmony import */ var core_js_fn_set__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! core-js/fn/set */ \"./node_modules/core-js/fn/set.js\");\n/* harmony import */ var core_js_fn_set__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(core_js_fn_set__WEBPACK_IMPORTED_MODULE_6__);\n/* harmony import */ var element_closest__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! element-closest */ \"./node_modules/element-closest/element-closest.js\");\n/* harmony import */ var element_closest__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(element_closest__WEBPACK_IMPORTED_MODULE_7__);\n/* harmony import */ var mutation_observer_inner_html_shim__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! mutation-observer-inner-html-shim */ \"./node_modules/mutation-observer-inner-html-shim/mutation-observer-inner-html-shim.js\");\n/* harmony import */ var mutation_observer_inner_html_shim__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(mutation_observer_inner_html_shim__WEBPACK_IMPORTED_MODULE_8__);\n\n\n\n\n\n\n\n\n\n\n\n//# sourceURL=webpack:///./node_modules/@stimulus/polyfills/index.js?");
...
/***/ 0:
/*!******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** multi ./node_modules/@babel/polyfill/dist/polyfill.js ./node_modules/@stimulus/polyfills/index.js ./app/assets/js/app.js ./app/assets/js/main.js ./app/assets/js/utils.js ./app/assets/js/helpers/bem.js ./app/assets/js/helpers/stimulus.js ./app/Views/components/deviceinformation/deviceinformation.js ./app/Views/components/notification-modal/notification-modal.js ./app/Views/components/sidenav/sidenav.js ./app/assets/js/helpers/env/origin.js ./app/assets/js/helpers/message-bus/message-bus.js ./app/assets/js/helpers/stimulus/component-controller.js ***!
  \******************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/node_modules/@babel/polyfill/dist/polyfill.js */\"./node_modules/@babel/polyfill/dist/polyfill.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/node_modules/@stimulus/polyfills/index.js */\"./node_modules/@stimulus/polyfills/index.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/app.js */\"./app/assets/js/app.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/main.js */\"./app/assets/js/main.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/utils.js */\"./app/assets/js/utils.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/helpers/bem.js */\"./app/assets/js/helpers/bem.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/helpers/stimulus.js */\"./app/assets/js/helpers/stimulus.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/Views/components/deviceinformation/deviceinformation.js */\"./app/Views/components/deviceinformation/deviceinformation.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/Views/components/notification-modal/notification-modal.js */\"./app/Views/components/notification-modal/notification-modal.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/Views/components/sidenav/sidenav.js */\"./app/Views/components/sidenav/sidenav.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/helpers/env/origin.js */\"./app/assets/js/helpers/env/origin.js\");\n__webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/helpers/message-bus/message-bus.js */\"./app/assets/js/helpers/message-bus/message-bus.js\");\nmodule.exports = __webpack_require__(/*! /Users/rickdgraaff/Projects/fpp/www/new/app/assets/js/helpers/stimulus/component-controller.js */\"./app/assets/js/helpers/stimulus/component-controller.js\");\n\n\n//# sourceURL=webpack:///multi_./node_modules/@babel/polyfill/dist/polyfill.js_./node_modules/@stimulus/polyfills/index.js_./app/assets/js/app.js_./app/assets/js/main.js_./app/assets/js/utils.js_./app/assets/js/helpers/bem.js_./app/assets/js/helpers/stimulus.js_./app/Views/components/deviceinformation/deviceinformation.js_./app/Views/components/notification-modal/notification-modal.js_./app/Views/components/sidenav/sidenav.js_./app/assets/js/helpers/env/origin.js_./app/assets/js/helpers/message-bus/message-bus.js_./app/assets/js/helpers/stimulus/component-controller.js?");
