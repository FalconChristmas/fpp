...
function help_help()
{
    $endpoints = array(
        ...
        ['GET /playlist/:PlaylistName/start<br>GET /playlist/:PlaylistName/start?scheduleProtected=true', 'Start the playlist named :PlaylistName. Optional query parameter scheduleProtected (true/false) prevents the scheduler from stopping this playlist.', '', ''],
        ['GET /playlist/:PlaylistName/start/:Repeat<br>GET /playlist/:PlaylistName/start/:Repeat?scheduleProtected=true<br>GET /playlist/:PlaylistName/start/:Repeat/:ScheduleProtected', 'Start the playlist named :PlaylistName with repeat mode. Optional scheduleProtected parameter (true/false) prevents the scheduler from stopping this playlist.', '', ''],
