...
dispatch_all('/files/Sequences/fps', 'get', 'GetSequenceFPS'); // keep above /files/:DirName
...
dispatch_all('/git/releases/notes/:tag', 'get', 'GitOSReleaseNotes');
...
dispatch_all('/network/wifi/status/:interface', 'get', 'NetworkWiFiStatus');
...
dispatch_all('/pipewire/audio/usb-check', 'get', 'GetUsbAudioBandwidthCheck');
dispatch_all('/pipewire/audio/sources', 'get', 'GetPipeWireAudioSources');
dispatch_all('/pipewire/audio/plugin-sources', 'get', 'GetPipeWirePluginSources');
...
dispatch_all('/pipewire/audio/services/restart', 'post', 'RestartPipeWireServices');
...
dispatch_all('/plugin/popularity', 'get', 'GetPluginPopularity');   // keep above /plugin/:RepoName
dispatch_all('/plugin/githubStats', 'get', 'GetPluginGitHubStats'); // keep above /plugin/:RepoName
dispatch_all('/plugin/fetchImage', 'get', 'PluginFetchImage');      // keep above /plugin/:RepoName
dispatch_all('/plugin/:RepoName', 'get', 'GetPluginInfo');
dispatch_all('/plugin/:RepoName/icon', 'get', 'PluginServeIcon');
dispatch_all('/plugin/:RepoName/page', 'get', 'GetPluginPageUrl');
...
// GeoIP
dispatch_all('/geoip', 'get', 'GetGeoIP');
...
dispatch_all('/settings/fanThermal/reset', 'post', 'ResetFanThermalTrips');
