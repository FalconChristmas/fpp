...
<?php
    ...
    foreach ($inputs as $input) {
        $inputData = explode(":", $input);
        $settingID = sprintf("GPIOInput%03dEnabled", $inputData[1]); ?>
		<tr><td><?php PrintSettingCheckbox("GPIO Input", $settingID, 1, 0, "1", "0"); ?></td>
				<td><?= $inputData[0]; ?></td>
				<td><?= $inputData[2]; ?></td>
				<td rowspan='2'>
					<table>
						<tr><td>Rising:</td><td><?php PrintEventOptions($inputData[1]); ?></td></tr>
						<tr><td>Falling:</td><td><?php PrintEventOptions($inputData[1], false); ?></td></tr>
					</table>
				</td>
				<td><?= $inputData[3]; ?></td>
		</tr><tr></tr>
...
?>
		<tr <?php echo $piFaceStyle; ?>><td colspan=5><br>NOTE: ** - BCM 25 conflicts with PiFace GPIO Inputs, do not enable BCM 25 when using a PiFace.<br></td></tr>
		<tr class='piFaceGPIO' <?php echo $piFaceStyle; ?>>
				<td colspan=6 align='center'><hr><b>PiFace GPIO Inputs</b></td>
		</tr>
		<tr class='fppTableHeader' <?php echo $piFaceStyle; ?>>
				<td>En.</td>
				<td>GPIO #</td>
				<td>wiringPi #</td>
				<td>Events</td>
...
<?php
    foreach ($piFaceInputs as $input) {
        ...
        $settingID = sprintf("GPIOInput%03dEnabled", $inputData[1]); ?>
		<tr class='piFaceGPIO' <?php echo $piFaceStyle; ?>>
				<td><?php PrintSettingCheckbox("GPIO Input", $settingID, 1, 0, "1", "0"); ?></td>
				<td><?= $inputData[0]; ?></td>
				<td><?= $inputData[2]; ?></td>
				<td rowspan='2'>
					<table>
