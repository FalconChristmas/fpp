...
<p><b>More detail:</b> Press F1 on this page again for the full reference of topics FPP publishes (ready, version, status, playlist/*, gpio/*, command/*) and subscribes to (<code>/set/command/…</code>, <code>/set/playlist/…</code>, <code>/light/MODEL/cmd</code>), plus Home Assistant examples. Also see <i>Help → MQTT Integration</i> and the <code>Settings → MQTT</code> advanced pane.</p>
