...
Otherwise you can visit the [Audio/Video](/settings.php#settings-av) settings page and select an alternative Audio Output Device.

If you have a USB audio adapter and are having problems, you can also try setting a FPP boot delay on the [System](/settings.php#settings-system) settings page.
