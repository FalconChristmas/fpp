...
If you have a USB audio adapter and are having problems, you can also try setting a FPP boot delay on the <a href="/settings.php#settings-system">System</a>  settings page.
