...
Note: on a device that has a cape or hat installed, the network/UDP outputs are hidden while **User Interface Level** is set to **Basic**.  Set it to **Advanced** on that device's System settings page to see and edit the UDP outputs.
