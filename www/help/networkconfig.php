...
<p><b>IP Address</b> — In Static mode enter the desired address as four decimal sections separated by periods (e.g. <code>192.168.0.26</code>). You do not need leading zeros, but all four sections are required.</p>

<p><b>Netmask</b> — In Static mode this is typically <code>255.255.255.0</code> for most home networks. If your network is unusual, use the netmask your network administrator provided.</p>

<p><b>Gateway</b> — In Static mode this is typically one of two addresses on home routers: the router’s own address, usually ending in <code>.1</code> or <code>.254</code> (e.g. <code>192.168.0.1</code>). If unsure, check the network properties of a laptop or desktop on the same network.</p>
