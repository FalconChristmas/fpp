...
<script>
    ...
    function filterScripts(searchTxt){
        ...
        $('#fppScripts .fppScriptEntry').filter(function() {
        ...
        <div class="pageContent">
            <div id="uiscripts" class="settings">
                        ...
                        <div class="backdrop mb-2 fppScriptEntry">
                            <div class="row">
                                ...
                                <div class="col-lg-auto fppScriptEntryCol">
                                    <input type='button' class='buttons' value='View' onClick='ViewRemoteScript("<?= $parts[0]; ?>", "<?= $parts[1]; ?>");'>
                                    <input type='button' class='buttons btn-success' value='Install' onClick='InstallRemoteScript("<?= $parts[0]; ?>", "<?= $parts[1]; ?>");'>
                                </div>
                            </div>
                        </div>
                    <?
                ...
                <? if ($settings["uiLevel"] >= 1 && !empty($nonMatchingScripts)) : ?>
                    <div class="callout">
                        <b>NOTE:</b> Some scripts such as the Remote Control scripts may require editing to configure variables to be functional. After installing a script from the Script Repository, you can view and download the script from the Scripts tab in the <a href='filemanager.php'>File Manager</a> screen.
                    </div>

                    <h2>Incompatible Scripts</h2>
                    <div class="callout">
                        The scripts below are from other versions of FPP and are known not to function with this version of FPP. They are listed here for your reference only.
                    </div>
