...
<div id='bodyWrapper'>
	...
	<div style='margin:0 auto;'> <br />
		<fieldset style='padding: 10px; border: 2px solid #000;'>
			<legend>Falcon <?php echo $hwModel; ?></legend>
			<div>
				<table>
					<tr><th align='left'>Model:</th><td><?php echo $hwModel; ?></td></tr>
					<tr><th align='left'>Firmware:</th><td><?php echo $hwFWVer; ?></td></tr>
				</table>
				<br>
				<form id='frmHardware'>
